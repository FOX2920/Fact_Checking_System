...
**Lưu ý**: Các bạn sẽ không sử dụng các kiến thức, thông tin ở bên ngoài mà chỉ dựa vào nội dung đoạn văn bản (context) cung cấp để đưa ra câu nhận định và sắp xếp nó vào nhãn thích hợp.
